...
#ifndef LIB_MOTORDRIVER_MOTOR_H_
#define LIB_MOTORDRIVER_MOTOR_H_

#include <Servo.h>

#include "IThrottleConsumer.h"

namespace MotorDriver {

	class Motor: public IThrottleConsumer {
	public:
...
#endif /* LIB_MOTORDRIVER_MOTOR_H_ */
